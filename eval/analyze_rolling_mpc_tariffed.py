...
def build_missed_export_report(
    ...
    *,
    ...
    preferred_cols = [
        ...
        "forecast_feed_in_step0_mwh_amber",
        "forecast_feed_in_step0_mwh_hybrid",
        "forecast_feed_in_mean_next_1h_mwh_amber",
        "forecast_feed_in_mean_next_1h_mwh_hybrid",
        "forecast_feed_in_mean_next_4h_mwh_amber",
        "forecast_feed_in_mean_next_4h_mwh_hybrid",
        "forecast_feed_in_mean_next_14h_mwh_amber",
        "forecast_feed_in_mean_next_14h_mwh_hybrid",
        "sell_urgency_applied_amber",
        "sell_urgency_applied_hybrid",
