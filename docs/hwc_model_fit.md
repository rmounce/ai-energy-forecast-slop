...
| --- | --- | --- |
| `thermal.nominal_power_w` | `790` | median clean HP proxy watts, rounded to 10 W |
...
| `thermocline_width_fraction` | `0.59` | estimated from median 10%→90% probe-rise timing span |
| `probe_rise_10_cycle_fraction` | `0.31` | diagnostic only |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| all_usable | 6 | 6.24 | 788 | 2.33 | 0.121 | 18.8 | 29.5 | 62.0 | 90.0 |
| full_reheat | 4 | 6.6 | 754 | 2.55 | 0.113 | 27.5 | 47.5 | 81.0 | 111.8 |
